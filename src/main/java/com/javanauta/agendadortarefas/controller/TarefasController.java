...
public class TarefasController {
    ...
    @GetMapping
    public ResponseEntity<List<TarefasDTO>> buscaTarefasPorEmai(@RequestHeader("Authorization") String token){
        List<TarefasDTO> tarefas = tarefasService.buscaTarefasPorEmai(token);
